...
Я сознательно не добавлял аутентификацию, загрузку резюме, отправку сообщений, AI-рейтинг и интеграции исходной Cynthia. Интерфейс работает после публикации DLL в IIS — это не отдельный статический макет.
