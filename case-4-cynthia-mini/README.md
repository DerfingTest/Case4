...
Главная страница Cynthia Mini показывает навигацию по разделам, описание системы и основные действия рекрутера. Для демонстрационного снимка интерфейс запущен с тестовыми ответами API.

![Главная страница Cynthia Mini](screenshot.png)
