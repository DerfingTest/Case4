...
Все внешние ключи я разместил в `tour_orders`. Благодаря этому один клиент, пункт назначения, формат тура или пакет услуг может быть связан с несколькими заказами.
